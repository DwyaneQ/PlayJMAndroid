 ...
 */
class SearchHotKeyAdapter(layoutResId: Int) :
    BaseQuickAdapter<HotKeyResult, BaseViewHolder>(layoutResId) {
    override fun convert(holder: BaseViewHolder, item: HotKeyResult) {
